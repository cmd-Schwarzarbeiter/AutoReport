...
//using static AutoReport.D_GUI.DynamicComponentInitializer;
...
namespace AutoReport
{
    public partial class Form1 : Form
    {
        ...
        private D_GUI.DynamicComponentInitializer initializer;
        public Form1()
        {
            InitializeComponent();
            initializer = new D_GUI.DynamicComponentInitializer(this);
        ...
        */
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //fuer jeden Eintrag in "Server" eine Combobox gefuellt mit dropboxen erstellen und dropboxen setzen
